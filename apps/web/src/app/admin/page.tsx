    ...
    <div>
      ...
      <div className={styles.cards}>
        <div className={styles.card}>
          ...
          <div className={styles.cardLink}><a href="/admin/urunler">Yönet →</a></div>
        </div>
        <div className={styles.card}>
          <div className={styles.cardIcon}>🛒</div>
          <div className={styles.cardLabel}>Siparişler</div>
          <div className={styles.cardLink}><a href="/admin/siparisler">Yönet →</a></div>
        </div>
        <div className={styles.card}>
          <div className={styles.cardIcon}>⭐</div>
          <div className={styles.cardLabel}>Yorumlar</div>
          <div className={styles.cardLink}><a href="/admin/yorumlar">Yönet →</a></div>
        </div>
      </div>
    </div>
  );
